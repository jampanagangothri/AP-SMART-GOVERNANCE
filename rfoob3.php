  ...
  <section class="mx-auto my-5" style="max-width: 23rem;">
    ...
    <div class="card testimonial-card mt-2 mb-3">
      ...
      <div class="card-body text-center">
        <h4 class="card-title font-weight-bold">Paushtik Hotel</h4>
        <hr>
...
<div class="col-3">
  <section class="mx-auto my-5" style="max-width: 23rem;">
    ...
    <div class="card testimonial-card mt-2 mb-3">
      ...
      <div class="card-body text-center">
        <h4 class="card-title font-weight-bold">Tuba Fine Dining Hotel</h4>
        <hr>
          <ul class="list-unstyled">
                 <li class="rating-item"><i class="fas fa-star"></i></li>
                <li class="rating-item"><i class="fas fa-star"></i></li>
...
<div class="col-3">
  <section class="mx-auto my-5" style="max-width: 23rem;">
    ...
    <div class="card testimonial-card mt-2 mb-3">
      ...
      <div class="card-body text-center">
        <h4 class="card-title font-weight-bold">Minerva Grand hotel</h4>
        <hr>
          <ul class="list-unstyled">
                 <li class="rating-item"><i class="fas fa-star"></i></li>
                <li class="rating-item"><i class="fas fa-star"></i></li>
...
<div class="col-3">
  <section class="mx-auto my-5" style="max-width: 23rem;">
    ...
    <div class="card testimonial-card mt-2 mb-3">
      ...
      <div class="card-body text-center">
        <h4 class="card-title font-weight-bold">The GateWay Hotel</h4>
        <hr>
          <ul class="list-unstyled">
                 <li class="rating-item"><i class="fas fa-star"></i></li>
                <li class="rating-item"><i class="fas fa-star"></i></li>
...
<h1 style="text-align:center;">Vijayawada food Courts</h1>
<div class="container">
   <div class="row">
<div class="col-3">
  <section class="mx-auto my-5" style="max-width: 23rem;">
    ...
    <div class="card testimonial-card mt-2 mb-3">
      ...
      <div class="card-body text-center">
        <h4 class="card-title font-weight-bold">Bombay Resturant</h4>
        <hr>
          <ul class="list-unstyled">
                 <li class="rating-item"><i class="fas fa-star"></i></li>
                <li class="rating-item"><i class="fas fa-star"></i></li>
...
<div class="col-3">
  <section class="mx-auto my-5" style="max-width: 23rem;">
    ...
    <div class="card testimonial-card mt-2 mb-3">
      ...
      <div class="card-body text-center">
        <h4 class="card-title font-weight-bold">SubWay Resturant</h4>
        <hr>
          <ul class="list-unstyled">
                 <li class="rating-item"><i class="fas fa-star"></i></li>
                <li class="rating-item"><i class="fas fa-star"></i></li>
...
<div class="col-3">
  <section class="mx-auto my-5" style="max-width: 23rem;">
    ...
    <div class="card testimonial-card mt-2 mb-3">
      ...
      <div class="card-body text-center">
        <h4 class="card-title font-weight-bold">Blue Box Resturant</h4>
        <hr>
          <ul class="list-unstyled">
                 <li class="rating-item"><i class="fas fa-star"></i></li>
                <li class="rating-item"><i class="fas fa-star"></i></li>
