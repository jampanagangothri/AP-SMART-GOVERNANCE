  ...
  <section class="mx-auto my-5" style="max-width: 23rem;">
    ...
    <div class="card testimonial-card mt-2 mb-3">
      ...
      <div class="card-body text-center">
        <h4 class="card-title font-weight-bold">Reddy Hotel</h4>
        <hr>
...
<div class="col-3">
  <section class="mx-auto my-5" style="max-width: 23rem;">
    ...
    <div class="card testimonial-card mt-2 mb-3">
      ...
      <div class="card-body text-center">
        <h4 class="card-title font-weight-bold">Medhendra Hotel</h4>
        <hr>
          <ul class="list-unstyled">4.2
                 <li class="rating-item"><i class="fas fa-star"></i></li>
                <li class="rating-item"><i class="fas fa-star"></i></li>
               <li class="rating-item"><i class="fas fa-star"></i></li>
                 <li class="rating-item"><i class="fas fa-star"></i></li>
...
<div class="col-3">
  <section class="mx-auto my-5" style="max-width: 23rem;">
    ...
    <div class="card testimonial-card mt-2 mb-3">
      ...
      <div class="card-body text-center">
        <h4 class="card-title font-weight-bold">Five Star hotel</h4>
        <hr>
...
<div class="col-3">
  <section class="mx-auto my-5" style="max-width: 23rem;">
    ...
    <div class="card testimonial-card mt-2 mb-3">
      ...
      <div class="card-body text-center">
        <h4 class="card-title font-weight-bold">Raheam Hotel</h4>
        <hr>
          <ul class="list-unstyled">4.0
                 <li class="rating-item"><i class="fas fa-star"></i></li>
                <li class="rating-item"><i class="fas fa-star"></i></li>
...
<h1 style="text-align:center;">Kadapa food Courts</h1>
<div class="container">
   <div class="row">
<div class="col-3">
  <section class="mx-auto my-5" style="max-width: 23rem;">
    ...
    <div class="card testimonial-card mt-2 mb-3">
      ...
      <div class="card-body text-center">
        <h4 class="card-title font-weight-bold">Meghana Resturant</h4>
        <hr>
...
<div class="col-3">
  <section class="mx-auto my-5" style="max-width: 23rem;">
    ...
    <div class="card testimonial-card mt-2 mb-3">
      ...
      <div class="card-body text-center">
        <h4 class="card-title font-weight-bold">Andhra Resturant</h4>
        <hr>
...
<div class="col-3">
  <section class="mx-auto my-5" style="max-width: 23rem;">
    ...
    <div class="card testimonial-card mt-2 mb-3">
      ...
      <div class="card-body text-center">
        <h4 class="card-title font-weight-bold">Priya Resturant</h4>
        <hr>
...
<div class="col-3">
  <section class="mx-auto my-5" style="max-width: 23rem;">
    ...
    <div class="card testimonial-card mt-2 mb-3">
      ...
      <div class="card-body text-center">
        <h4 class="card-title font-weight-bold">chinna Resturant</h4>
        <hr>
          <ul class="list-unstyled">4.0
                 <li class="rating-item"><i class="fas fa-star"></i></li>
                <li class="rating-item"><i class="fas fa-star"></i></li>
